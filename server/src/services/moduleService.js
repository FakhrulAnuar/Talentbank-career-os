...
// Listing is PROFILE-AWARE: courses whose tags match the user's target field/interests are
// flagged 'recommended'; soft-skill/general courses (alwaysShow) are flagged 'essential' and
// surface for everyone. Completed module points feed the derived Pathway Score.
...
// How well a module's tags match the user's profile (target field + interests).
